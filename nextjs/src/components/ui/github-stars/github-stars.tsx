...
export const GithubStarsButton = ({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            ...
            style={{
              background: "linear-gradient(135deg, #efc900, #f59e0b, #F5833F)",
            }}
          />
        </span>
      </span>
      ...
      <span className="relative z-[1] flex w-full items-center justify-center gap-1 rounded-full bg-neutral-50/90 px-4 py-2 pl-2 dark:bg-neutral-950/90">
        ...
        <span
          className="absolute -left-2 -top-1 size-11 -translate-x-1/2 -translate-y-1/2 rounded-full opacity-0 blur-lg dark:opacity-30"
          style={{
            animation: "14s ease-in-out infinite alternate star-shine",
            background:
              "linear-gradient(135deg, #3BC4F2, #efc900, #f59e0b, #F5833F)",
          }}
        />
        <NumberFlow
          value={starNumber}
          ...
          className="z-20 w-1.5 text-xs font-semibold tracking-tighter text-neutral-400 dark:text-white"
        />
        {children && (
          <span className="ml-1.5 transform-gpu bg-gradient-to-b from-neutral-950 to-neutral-950/50 bg-clip-text text-xs text-transparent transition group-hover:scale-105 dark:from-white dark:to-white">
            {children}
          </span>
        )}
      </span>
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#efc900" />
          <stop offset="0.575" stopColor="#f59e0b" />
